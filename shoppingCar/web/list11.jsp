...
<img src="img/L11.jpg" alt="" style="margin-left: 80px;margin-top:80px">
<br><br><br>
<div style="position: absolute;width:800px;height:330px;margin-left: 600px;margin-top: -375px;">
    <form action="${pageContext.request.contextPath}/ShoppingCarServlet" style="position: absolute;margin-left: 400px;margin-top: -375px">
        <input type="text" value="   柿  子  椒" name="productName" style="position: relative;top: 380px;left: -300px;font-size: 30px;width: 140px;height: 50px;color: red">
        <p style="margin-left: -290px;font-size: 60px;position: absolute;top: 420px">价格:</p><input type="text" name="unitPrice" value="5" style="margin-left: -290px;margin-top: 25px;font-size: 60px;position: absolute;top: 600px;width:125px;height: 50px"></input>
        <table>
            <tr>
